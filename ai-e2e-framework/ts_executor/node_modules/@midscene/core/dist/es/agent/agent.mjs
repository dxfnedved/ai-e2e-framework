...
class Agent {
    ...
    constructor(interfaceInstance, opts){
        ...
        const useCache = 'boolean' == typeof (null == opts ? void 0 : opts.useCache) ? opts.useCache : globalConfigManager.getEnvConfigInBoolean(MIDSCENE_CACHE);
        if (null == opts ? void 0 : opts.cacheId) this.taskCache = new TaskCache(opts.cacheId, useCache);
