...
class Agent {
    ...
    async aiAction(taskPrompt, opt) {
        ...
        const { output, executor } = await this.taskExecutor.action(taskPrompt, modelConfig, this.opts.aiActionContext);
    ...
    async aiAssert(assertion, msg, opt) {
        ...
        const { output, executor, thought } = await this.taskExecutor.assert(assertion, modelConfig, insightOpt);
    ...
    constructor(interfaceInstance, opts){
        ...
        const useCache = 'boolean' == typeof (null == opts ? void 0 : opts.useCache) ? opts.useCache : env_namespaceObject.globalConfigManager.getEnvConfigInBoolean(env_namespaceObject.MIDSCENE_CACHE);
        if (null == opts ? void 0 : opts.cacheId) this.taskCache = new external_task_cache_js_namespaceObject.TaskCache(opts.cacheId, useCache);
